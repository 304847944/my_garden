...
object MyGLUtils {
    ...
    fun genTexture(textureType: Int = GLES20.GL_TEXTURE_2D): Int {
        ...
        // Set texture default draw parameters视频流使用这个
        //https://blog.csdn.net/qjh5606/article/details/88538701?utm_medium=distribute.pc_relevant.none-task-blog-BlogCommendFromMachineLearnPai2-4.edu_weight&depth_1-utm_source=distribute.pc_relevant.none-task-blog-BlogCommendFromMachineLearnPai2-4.edu_weight
