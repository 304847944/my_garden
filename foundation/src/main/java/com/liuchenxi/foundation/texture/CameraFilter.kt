 ...
 class CameraFilter(context: Context?) {
    ...
    fun draw(cameraTexId: Int, canvasWidth: Int, canvasHeight: Int) {
        ...
        if (CAMERA_RENDER_BUF == null || CAMERA_RENDER_BUF!!.width !== canvasWidth || CAMERA_RENDER_BUF!!.height !== canvasHeight
            ...
            CAMERA_RENDER_BUF =
                RenderBuffer(canvasWidth, canvasHeight, BUF_ACTIVE_TEX_UNIT)
        }
...
//        GLES20.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, cameraTexId)
    ...
    fun setupShaderInputs(
        ...
        GLES20.glUniform3fv(
            ...
            FloatBuffer.wrap(
                floatArrayOf(
                    iResolution[0].toFloat(),
                    iResolution[1].toFloat(),
                    1.0f
                )
            )
        )
        val time =
            (System.currentTimeMillis() - START_TIME).toFloat() / 1000.0f
        ...
        val _iChannelResolutions =
            FloatArray(iChannelResolutions.size * 3)
        ...
        val iChannelResolutionLocation =
            GLES20.glGetUniformLocation(program, "iChannelResolution")
        GLES20.glUniform3fv(
